...
const MapPage = () => {
    ...
    useEffect(() => {
        ...
        const initializeMapFeatures = () => {
                        ...
                        setTimeout(() => {
                            ...
                            if (joinBtn) {
                                joinBtn.addEventListener('click', () =>
                                    handleJoinGame(game, [map.getCenter().lng, map.getCenter().lat])
                                );
                            }
                        }, 0);
                    });
            ...
            // ✅ Fixed geolocation trigger with delay
            ...
            geolocate.on('error', (e) => {
                ...
                Swal.fire("Geolocation Error", "Unable to get your location. Please check permissions.", "warning");
            });
